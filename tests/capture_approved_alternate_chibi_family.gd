...
const IDENTITY_TEST_SAVE_PATH := "user://test_capture_approved_alternate_chibi_identity.cfg"
const DECOR_TEST_SAVE_PATH := "user://test_capture_approved_alternate_chibi_decor.cfg"
