...
기본 후면 3/4와 하단 약 20% 구도를 유지한다. 사용자 드래그 둘러보기의 첫 시험 범위는 기존 yaw ±135°, pitch -16°..38°이며 완전한 360°·수중·배 밑 관찰은 약속하지 않는다. 수평선 roll=0, 관성·자동 orbit·자동 줌은 기본 제외한다. 범위 안에서 단일 선체/캐릭터의 실루엣·의상·가림이 연속적이어야 한다. 기본 시점 복귀 후 같은 항해를 유지한다.
