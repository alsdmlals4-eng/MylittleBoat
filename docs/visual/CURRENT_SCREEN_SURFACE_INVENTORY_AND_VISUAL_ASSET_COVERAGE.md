...
| `MLB-AMB-SEASONAL-ISLAND-001` | source `docs/visual/generated/2026-09-01-seasonal-parallax-bright/bright-spring-islet-candidate.png` → runtime `assets/images/runtime/voyage/seasonal_parallax/bright-spring-islet.png` | `1672×941`, RGBA | `22E9AE8B74B331F7147936B780823D81EA59DD407837BF4ACBC9F82FFC046987` | sky·ocean·reflection 없이 꽃·나무·풀·바위만 남긴 Bright/spring distant island | `GameScene/VoyageWorld/SeasonalIslandLayer` 한 개를 normal·Appreciation·LookAround가 shared layer 1에서 관찰. 세계 앵커 고정, 승인 원경 billboard, actual route 거리 기반 통과. Existing source를 복제하지 않고 `region_enabled`, `Rect2(632, 350, 1028, 350)`, `pixel_size=0.005`로 투명 여백을 제외한 원거리 landmark만 사용하며 세계 중앙 항로에는 진입하지 않음. 현재 검증은 `docs/evidence/2026-09-13-world-island/REVIEW.md`; 아래 9/1 화면/수치는 당시 구조의 역사 증거 |
