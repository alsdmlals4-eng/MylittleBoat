...
**작고 둥근 보트 디오라마에서 내 캐릭터와 동반자가 잔잔한 바다·파도소리와 함께 아무것도 하지 않아도 편안한 시간을 보내는 게임.**
...
- active foreground 시간에 따라 먼 구조물과 주변 풍경이 낮은 밀도로 흘러갑니다. 이것은 과제·보상 track이나 놓친 이벤트 패널이 아닙니다.
