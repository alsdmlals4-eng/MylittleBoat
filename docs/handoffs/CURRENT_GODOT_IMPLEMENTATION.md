...
- The internal Windows package route is limited to one x86_64 debug export preset and a GitHub Actions ZIP artifact containing the executable, PCK, and SHA-256 manifest. The `main` push run for PR #59 merge commit `7f9bbdd0138bb3d6a3d4fff629d563cb66b407b8` passed at https://github.com/alsdmlals4-eng/MylittleBoat/actions/runs/33071234998; downloaded artifact files matched `SHA256SUMS.txt`. This is machine package evidence only; no Android/public-store/signing work and no Human Windows launch or mobile comfort claim are included.
