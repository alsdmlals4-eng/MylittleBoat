...
- 첫 섬 플레이의 조사·대안·카메라/농사/저장 명세·구현 순서 후보 — `PROJECT_GDD.md`의 `첫 섬 플레이 설계 후보 — 2026-09-20`. 자산/모션 상태군은 visual inventory의 같은 날짜 절. `RESEARCHED_DESIGN_CANDIDATE`이며 구현·최종 아트 승인이 아니다.
