...
FINAL_AVATAR_ART = RUNTIME_CAPTURE_AWAITING_HUMAN_APPROVAL
FINAL_PET_ART = RUNTIME_CAPTURE_AWAITING_HUMAN_APPROVAL
FINAL_BOAT_SEA_ART = RUNTIME_CAPTURE_AWAITING_HUMAN_APPROVAL
```
