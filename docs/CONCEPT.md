...
낚시, 풍경사진, 꾸미기, 작은 상호작용, Ambient Discovery는 원할 때 자유롭게 오가는 곁가지입니다. 이들은 항해마다 하나를 고르게 하거나, 바로 실행하라고 재촉하거나, 순서·보상·성장 효율을 만들지 않습니다. 보드와 후속 UI는 정상 디오라마의 휴식을 중심에 두고, 선택 활동을 조용한 주변 경로로 보여줍니다.
